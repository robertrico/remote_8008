...
class BaseSoC(SoCCore):
    def __init__(self, sys_clk_freq=75e6, device="LFE5UM5G", toolchain="trellis", **kwargs):
        ...
        self.b8008 = B8008Core(platform,
            ...
            rom_init     = load_mem_file(os.path.join(_HERE, "..", "b8008_monitor", "src", "rom_baked.mem")))
        # Wishbone window: word index == absolute 14-bit 8008 address (16384 words).
        self.bus.add_slave("b8008_ram", self.b8008.bus_ram,
            SoCRegion(origin=0x9000_0000, size=0x10000, cached=False))
